...
namespace EcoSim.Boot
{
    ...
    public sealed class GameRoot : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            if (SaveSystem.TryLoad(SavePath, out WorldState loaded, out System.DateTime lastPlayed)
        ...
        private void SaveNow()
        {
            ...
            SaveSystem.Save(World, System.DateTime.UtcNow, SavePath);
        }

        // 초기 시드: 토양/수분 랜덤 베이스 + 식물 약간 + 초식/포식 군데군데 패치.
        private static void SeedWorld(WorldState w, int seed)
        {
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                w.Water[i] = 0.4f + 0.4f * (float)rng.NextDouble();
